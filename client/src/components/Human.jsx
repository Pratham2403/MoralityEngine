...
export function Human({ animationName = "idle", ...props }) {
  const groupRef = useRef();
  const { nodes, materials } = useGLTF("/models/developer/human.glb");
...
useGLTF.preload("/models/developer/human.glb");
