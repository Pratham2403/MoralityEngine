...
export function HumanTwo({animationName='clap',...props}) {

  const groupRef = useRef();
    const { nodes, materials } = useGLTF('/models/developer/humanTwo.glb')
...
useGLTF.preload('/models/developer/humanTwo.glb')
